package com.gofobao.framework.common.qiniu.processing;
...
public final class OperationManager {
     ...
     */
    public com.qiniu.processing.OperationStatus prefop(String persistentId) throws QiniuException {
        ...
        com.qiniu.processing.OperationStatus status = response.jsonToObject(com.qiniu.processing.OperationStatus.class);
        return status;
    }
}

package com.gofobao.framework.common.qiniu.common;

import com.gofobao.framework.common.qiniu.util.Json;
...
public class ZoneReqInfo {
    ...
    public ZoneReqInfo(String token) throws QiniuException {
        ...
        try {
            ...
            accessKey = strings[0];
            String policy = new String(UrlSafeBase64.decode(strings[2]), com.qiniu.common.Constants.UTF_8);

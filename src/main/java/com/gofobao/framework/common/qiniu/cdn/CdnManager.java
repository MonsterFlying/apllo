...
public final class CdnManager {
    ...
    * */
     ...
     * @return 刷新请求的回复
     */
    public com.qiniu.cdn.CdnResult.RefreshResult refreshUrls(String[] urls) throws QiniuException {
     ...
     * @return 刷新请求的回复
     */
    public com.qiniu.cdn.CdnResult.RefreshResult refreshDirs(String[] dirs) throws QiniuException {
     ...
     * @return 刷新请求的回复
     */
    public com.qiniu.cdn.CdnResult.RefreshResult refreshUrlsAndDirs(String[] urls, String[] dirs) throws QiniuException {
        //check params
        ...
        return response.jsonToObject(com.qiniu.cdn.CdnResult.RefreshResult.class);
    }
     ...
     * @return 预取请求的回复
     */
    public com.qiniu.cdn.CdnResult.PrefetchResult prefetchUrls(String[] urls) throws QiniuException {
        ...
        StringMap headers = auth.authorizationV2(url, "POST", body, Client.JsonMime);
        Response response = client.post(url, body, headers, Client.JsonMime);
        return response.jsonToObject(com.qiniu.cdn.CdnResult.PrefetchResult.class);
    }
     ...
     * @return 获取带宽数据请求的回复
     */
    public com.qiniu.cdn.CdnResult.BandwidthResult getBandwidthData(String[] domains, String startDate, String endDate,
        ...
        StringMap headers = auth.authorizationV2(url, "POST", body, Client.JsonMime);
        Response response = client.post(url, body, headers, Client.JsonMime);
        return response.jsonToObject(com.qiniu.cdn.CdnResult.BandwidthResult.class);
    }
     ...
     * @return 获取流量数据请求的回复
     */
    public com.qiniu.cdn.CdnResult.FluxResult getFluxData(String[] domains, String startDate, String endDate,
                                                          String granularity) throws QiniuException {
        HashMap<String, String> req = new HashMap<>();
        req.put("domains", StringUtils.join(domains, ";"));
        req.put("startDate", startDate);
        ...
        StringMap headers = auth.authorizationV2(url, "POST", body, Client.JsonMime);
        Response response = client.post(url, body, headers, Client.JsonMime);
        return response.jsonToObject(com.qiniu.cdn.CdnResult.FluxResult.class);
    }
     ...
     * @return 获取日志下载链接的回复
     */
    public com.qiniu.cdn.CdnResult.LogListResult getCdnLogList(String[] domains, String logDate) throws QiniuException {
        HashMap<String, String> req = new HashMap<>();
        req.put("domains", StringUtils.join(domains, ";"));
        req.put("day", logDate);
        ...
        StringMap headers = auth.authorizationV2(url, "POST", body, Client.JsonMime);
        Response response = client.post(url, body, headers, Client.JsonMime);
        return response.jsonToObject(com.qiniu.cdn.CdnResult.LogListResult.class);
    }

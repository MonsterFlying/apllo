...
public enum AssetChangeTypeEnum {
     ...
     * 借款人扣除还款违约金
     */
    repayPaymentsViolation("扣除还款违约金", "receivedPaymentsPenalty", "7781", "add@useMoney", "add@incomeOther", "D"),


    /**
     * 投资人收到还款违约金
     */
    receivedPaymentsViolation("收到还款违约金", "receivedPaymentsPenalty", "7781", "add@useMoney", "add@expenditureOther", "D"),

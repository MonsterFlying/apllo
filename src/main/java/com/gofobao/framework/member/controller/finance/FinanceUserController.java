...
public class FinanceUserController {
    ...
    @ApiOperation("更改手机号")
    @PostMapping("/user/finance/v2/phone/switch")
    ...
    @PostMapping("/pub/user/finance/v2/info/checkOnly")
    ...
    @ApiOperation("绑定手机")
    @PostMapping("/user/finance/v2/phone/bind")
    ...
    @ApiOperation("绑定邮箱")
    @PostMapping("/user/finance/v2/email/bind")
    ...
    @ApiOperation("获取签约状态")
    @PostMapping("/user/finance/v2/sign")
    ...
    @GetMapping("/user/finance/v2/phone/switchVerify/{smsCode}")
    ...
    @PostMapping("/user/finance/v2/configInfo")
    ...
    @ApiOperation("获取存管信息")
    @PostMapping("/user/finance/v2/openAccountInfo")
    ...
    @ApiOperation("客服列表")
    @GetMapping("/user/finance/v2/service/list")
    ...
    @ApiOperation("vip信息")
    @GetMapping("/user/finance/v2/vip/info")
    ...
    @ApiOperation("申请vip")
    @PostMapping("/user/finance/v2/applyFor/vip")

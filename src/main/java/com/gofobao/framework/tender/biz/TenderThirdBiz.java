...
public interface TenderThirdBiz {
     ...
     * @return
     */
    ResponseEntity<VoBaseResp> thirdBatchCreditInvest(VoThirdBatchCreditInvest voThirdBatchCreditInvest);
     ...
     * @return
     */
    void thirdBatchCreditInvestRunCall(HttpServletRequest request, HttpServletResponse response);
}

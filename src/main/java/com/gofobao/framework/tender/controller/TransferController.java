...
public class TransferController {
    ...
    private ResponseEntity<VoBorrowTenderUserWarpListRes> transferUserList(@PathVariable Long transferId ) {
    ...
    private ResponseEntity<Integer> buyCount(@PathVariable Long transferId) {
